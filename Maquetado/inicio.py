...
class Inicio(tk.Tk):
    def __init__(self):
        ...
        self.aprendeCV = ttk.Button(self.fr, text="Aprende a redactar tu CV", style="TButton", command=self.prueba)
        self.aprendeCV.grid(row=1,column=0, sticky="w", padx=10, pady=10)

        self.aprendeEntrevista = ttk.Button(self.fr, text="Aprende a preparar tu entrevista", style="TButton", command=self.prueba)
        self.aprendeEntrevista.grid(row=2,column=0, sticky="w", padx=10, pady=10)

        self.practica = ttk.Button(self.fr, text="Practica tu entrevista", style="TButton", command=self.prueba)
        self.practica.grid(row=3,column=0, sticky="w", padx=10, pady=10)

        self.historial = ttk.Button(self.fr, text="Historial", style="TButton", command=self.prueba)
